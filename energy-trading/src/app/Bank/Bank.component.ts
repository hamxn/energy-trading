...
export class BankComponent {
  ...
  createAssetsBank(): Promise<any> {
    ...
    this.coins = {
      $class: "org.energy.trading.network.Coins",
          "coinsID":"CO_B" + this.bankID.value,
    ...
    this.bank = {
      $class: "org.energy.trading.network.Bank",
          "bankID":this.bankID.value,
          "name":this.name.value,
          "coins":"CO_B" + this.bankID.value,
          "cash":"CA_B" + this.bankID.value
    };
  ...
  updateBank(form: any): Promise<any> {
    ...
    this.bank = {
      $class: "org.energy.trading.network.Bank",          
              "name":this.name.value,                      
              "coins": "resource:org.energy.trading.network.Coins#CO_B" + form.get("bankID").value,
              "cash": "resource:org.energy.trading.network.Cash#CA_B" + form.get("bankID").value,
    };
  ...
  deleteBank(): Promise<any> {
    ...
    .then(() => {
      ...
      this.serviceBank.deleteCoins("CO_B"+this.currentId)
      .toPromise()
      .then(() => {
            
            //call serviceBank to delete cash asset, pass cashID as parameter
            this.serviceBank.deleteCash("CA_B"+this.currentId)
            .toPromise()
            .then(() => {
                console.log("Deleted")
