...
export class ResidentComponent {
  ...
  createAssetsResident(): Promise<any> {
    ...
    this.coins = {
      $class: "org.energy.trading.network.Coins",
          "coinsID":"CO_R" + this.residentID.value,
    ...
    this.energy = {
      $class: "org.energy.trading.network.Energy",
          "energyID":"EN_R" + this.residentID.value,
    ...
    this.cash = {
      $class: "org.energy.trading.network.Cash",
          "cashID":"CA_R" + this.residentID.value,
    ...
    this.resident = {
      $class: "org.energy.trading.network.Resident",
          "residentID":this.residentID.value,
          "firstName":this.firstName.value,
          "lastName":this.lastName.value,
          "coins":"CO_R" + this.residentID.value,
          "cash":"CA_R" + this.residentID.value,
          "energy":"EN_R" + this.residentID.value,
      };    
  ...
  updateResident(form: any): Promise<any> {
    ...
    this.resident = {
      ...
      "firstName":this.firstName.value,          
      "lastName":this.lastName.value,
      "coins": "resource:org.energy.trading.network.Coins#CO_R" + form.get("residentID").value,
      "cash": "resource:org.energy.trading.network.Cash#CA_R" + form.get("residentID").value,
      "energy": "resource:org.energy.trading.network.Energy#EN_R" + form.get("residentID").value
    };
  ...
  deleteResident(): Promise<any> {
    ...
    .then(() => {
      ...
      this.serviceResident.deleteCoins("CO_R"+this.currentId)
      .toPromise()
      .then(() => {

          //call serviceResident to delete energy asset, pass energyID as parameter
          this.serviceResident.deleteEnergy("EN_R"+this.currentId)
          .toPromise()
          .then(() => {

              //call serviceResident to delete cash asset, pass cashID as parameter
              this.serviceResident.deleteCash("CA_R"+this.currentId)
              .toPromise()
              .then(() => {
                  console.log("Deleted")
