...
export class UtilityCompanyComponent {
  ...
  createAssetsUtility(): Promise<any> {
    ...
    this.coins = {
      $class: "org.energy.trading.network.Coins",
          "coinsID":"CO_U" + this.utilityID.value,
    ...
    this.energy = {
      $class: "org.energy.trading.network.Energy",
          "energyID":"EN_U" + this.utilityID.value,
    ...
    this.utilityCompany = {
      $class: "org.energy.trading.network.UtilityCompany",
          "utilityID":this.utilityID.value,
          "name":this.name.value,
          "coins":"CO_U" + this.utilityID.value,
          "energy":"EN_U" + this.utilityID.value,
    };    
  ...
  updateUtilityCompany(form: any): Promise<any> {
    ...
    this.utilityCompany = {
      $class: "org.energy.trading.network.UtilityCompany",          
              "name":this.name.value,                    
              "coins": "resource:org.energy.trading.network.Coins#CO_U" + form.get("utilityID").value,
              "energy": "resource:org.energy.trading.network.Energy#EN_U" + form.get("utilityID").value
    };
  ...
  deleteUtilityCompany(): Promise<any> {
    ...
    .then(() => {
      ...
      this.serviceUtilityCompany.deleteCoins("CO_U"+this.currentId)
      .toPromise()
      .then(() => {

          //call serviceUtilityCompany to delete energy asset, pass energyID as parameter
          this.serviceUtilityCompany.deleteEnergy("EN_U"+this.currentId)
          .toPromise()
          .then(() => {
              console.log("Deleted")     
