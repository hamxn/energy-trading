...
@Injectable()
export class TransactionUMService {

    //define namespace strings for api calls
    private UTILITY: string = 'UtilityCompany';
    ...
    constructor(private utilityService: DataService<UtilityCompany>, private residentService: DataService<Resident>, private coinsService: DataService<Coins>, private energyService: DataService<Energy>, private orderService: DataService<Order>, private energyToCoinsService: DataService<EnergyToCoins>) {
    };

    //get all utility objects on the blockchain network
    public getAllUtilityCompanies(): Observable<UtilityCompany[]> {
      return this.utilityService.getAll(this.UTILITY);
    }
